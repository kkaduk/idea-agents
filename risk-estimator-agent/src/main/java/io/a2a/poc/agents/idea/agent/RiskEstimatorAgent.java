...
@Component
@A2AAgent(name = "RiskEstimatorAgent", version = "1.0.0", description = "Uses AI to assess financial and operational risks using FIBO standards", url = "http://localhost:8082")
...
public class RiskEstimatorAgent {
    ...
    @A2AAgentSkill(id = "assess-comprehensive-risk", name = "Comprehensive Risk Assessment with AI", description = "Uses AI to analyze all risk categories using FIBO ontology standards", tags = {
            "risk-assessment", "ai-analysis", "FIBO", "comprehensive" }, examples = {
    ...
    @A2AAgentSkill(id = "assess-regulatory-compliance", name = "Regulatory Compliance Risk Assessment with AI", description = "Uses AI to evaluate regulatory compliance requirements and associated risks", tags = {
